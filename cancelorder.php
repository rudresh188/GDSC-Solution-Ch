...
<title> Request Cancelation</title>
</head>
<body>
...
<table border="1"  cellpadding="10" style="border-collapse: collapse; border-spacing:0; width: 100%; text-align: center;">
  <tr align="center">
   <th colspan="4" >Cancel Request #<?php echo  $orderid;?></th> 
  </tr>
  <tr>
...
<tr>
  <td colspan="2" align="center"><button type="submit" name="submit" class="btn btn-primary">Update</button></td>
...
<p style="color:red; font-size:20px;"> Request Cancelled</p>
<?php } else { ?>
  <p style="color:red; font-size:20px;"> You can't cancel this. Request is on the way or delivered</p>
